package me.jincrates.kafka.config;

import java.util.HashMap;
import java.util.Map;
import lombok.RequiredArgsConstructor;
import me.jincrates.coffee.infrastructure.kafka.config.data.KafkaConfigData;
import me.jincrates.coffee.infrastructure.kafka.config.data.KafkaConsumerConfigData;
